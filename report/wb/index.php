        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div style="padding-top:20px; " class="block block-transparent">
                    ...
                    $numbers1 = array(10010,10011,10012,10013,10014,10015, 10016, 10017, 10018, 10019);
                            $ready=0;
                            $notready=0;
                ...
                <div style="margin-top:20px;" class="block block-drop-shadow">
                    <div class="content content-transparent np">
                        <div class="list list-contacts">
                            ...
                            $numbers = array(10010, 10011, 10012, 10013, 10014);
                ...
                <div style="margin-top:20px;" class="block block-drop-shadow">
                    <div class="content content-transparent np">
                        <div class="list list-contacts">
                            ...
                            $numbers = array(10015, 10016, 10017, 10018, 10019);
