...
<?php
$url = "https://uidesk.id/Asterisk/roatex/be-reportdetailcall.php?q=table&search=".($_GET['search'] ?? "")."&start_date=".($_GET['start_date'] ?? "")."&end_date=".($_GET['end_date'] ?? "");
            ...
            <tbody>
                ...
                foreach ($data as $key => $row) { $i++;?>
                    <tr>
                        <th><?= $i ?></th>
                        <td><?= $row['uniqueid'] ?></td>
                        <td><?= $row['CHAN_START'] ?></td>
                        <td><?= $row['ANSWER'] ?></td>
                        <td><?= $row['BRIDGE_ENTER'] ?></td>
                        <td><?= $row['BRIDGE_EXIT'] ?></td>
                        <td><?= $row['HANGUP'] ?></td>
                        <td><?= $row['CHAN_END'] ?></td>
                        <td><?= $row['LINKEDID_END'] ?></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
