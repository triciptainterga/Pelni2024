...
where  calldate between '2023-12-27 08:00:00' and '2023-12-27 09:00:00' ".$add_query."  order by calldate ASC");
}elseif($_GET['q']=="summary"){
$three_days_ago = date("Y-m-d 00:00:00", strtotime("-3 days", time()));
$result = $mysqli -> query("select 'TOTAL CALL' as Keterangan,count(TotalCall) as TotalCall from(
select calldate as TotalCall from asteriskcdrdb.cdr where calldate between '2023-12-27 08:00:00' and '2023-12-27 09:00:00' group by calldate
) as a

UNION
select 'CALL ANSWERED' as Keterangan,count(TotalCall) as TotalCall from(
select calldate as TotalCall from asteriskcdrdb.cdr where calldate between '2023-12-27 08:00:00' and '2023-12-27 09:00:00' 
