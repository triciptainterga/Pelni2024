                    ...
                    <div class="box-body p-15">
                        ...
                        <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" DataSourceID="tempTrxEmail" runat="server" Width="100%"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataDateColumn Caption="Email Date Received" FieldName="Email_Date" Width="250px" PropertiesDateEdit-DisplayFormatString="yyyy-MM-dd HH:mm:ss"></dx:GridViewDataDateColumn>
                                <dx:GridViewDataDateColumn Caption="Email Date Distribute" FieldName="DateReceived" Width="250px" PropertiesDateEdit-DisplayFormatString="yyyy-MM-dd HH:mm:ss"></dx:GridViewDataDateColumn>
                                <dx:GridViewDataDateColumn Caption="Email Date Reply" FieldName="DateReply" Width="250px" PropertiesDateEdit-DisplayFormatString="yyyy-MM-dd HH:mm:ss"></dx:GridViewDataDateColumn>
