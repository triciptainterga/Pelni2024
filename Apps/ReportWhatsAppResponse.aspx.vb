...
Public Class ReportWhatsAppResponse
    ...
    Private Sub btn_Submit_Click(sender As Object, e As EventArgs) Handles btn_Submit.Click
        ...
        Dim queryInsert As String = "EXEC UIDESK_MULTICHAT_RESPONSETIME '" & CmbChannel.Value & "','" & Session("UserName") & "','" & Format(dt_strdate.Value, "yyyy-MM-dd") & "','" & Format(dt_endate.Value, "yyyy-MM-dd") & "'"
        ...
        Catch ex As Exception
            Response.Write(DirectCast(ex.Message() & "_exec Call_XtraRepot_CallHistory EXEC UIDESK_MULTICHAT_RESPONSETIME '" & CmbChannel.Value & "','" & Session("UserName") & "','" & Format(dt_strdate.Value, "yyyy-MM-dd") & "','" & Format(dt_endate.Value, "yyyy-MM-dd") & "'", String))
        End Try
    ...
    Private Sub ASPxGridView1_Init(sender As Object, e As EventArgs) Handles ASPxGridView1.Init
        ...
        TempBaseTrx.SelectCommand = "EXEC SP_t_UIDESK_MULTICHAT_RESPONSETIME '" & CmbChannel.Value & "','" & Session("UserName") & "','" & Format(dt_strdate.Value, "yyyy-MM-dd") & "','" & Format(dt_endate.Value, "yyyy-MM-dd") & "'"
    End Sub
