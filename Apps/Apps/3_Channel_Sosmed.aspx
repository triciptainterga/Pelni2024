                                            ...
                                            <div class="flexbox align-items-center p-15">
                                                <div>
                                                    <div class="lookup lookup-circle lookup-right">
                                                        Pencarian menggunakan Nama,Email,No Telp
                                                        <input type="text" id="txtKeySearch" data-provide="media-search">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <ul class="todo-list">
                                    <li class="b-1 p-0 mb-15">
                                        <div class="position-relative p-20">
                                            ...
                                            <div class="mt-5 ml-50 pl-5" id="script_19">
                    ...
                    How may I assist you?
                                    ...
                                    <li class="b-1 p-0 mb-15">
                                        <div class="position-relative p-20">
                                            ...
                                            <div class="mt-5 ml-50 pl-5" id="script_20">
                                                “You’re certainly welcome, [CUSTOMER NAME]. 
        ...
        <div class="container-full">
                                    ...
                                    <ul class="box-controls pull-right">
                                        ...
                                        <li class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="#" onclick="DivShowSearchData(1)">
                                                    <img src="../Images/icon/search.png" width="20" />
                                                    Search Data</a>
                                                <a class="dropdown-item" href="#" onclick="DivShowSearchData(2)">
                                                    <img src="../Images/icon/-totaltickets.png" width="20" />
                                                    View Menu</a>
                                    ...
                                    <div class="box no-shadow bg-transparent b-0">
                                        ...
                                        <div class="box-body mailbox-nav p-0">
                                            <ul class="nav nav-pills flex-column">
                                                <li class="nav-item"><a class="nav-link" href="?flagto=msg" id="ChatInteraction">
                                                    <img src="star.png" width="24" />
                                                    Chat Interaction</a></li>
												<li class="nav-item"><a class="nav-link" href="?flagto=dashboard" id="Dashboard">
                                                    <img src="star.png" width="24" />
                                                    Dashboard Analytic</a></li>
                                              <%--  <li class="nav-item"><a class="nav-link" href="?flagto=comment">
                                                    <img src="star.png" width="24" />
                                                    Post Interaction</a></li>--%>
            ...
            <section class="right-block content" id="SideRightMenu">
                ...
                <div class="row" id="multichatIframe">
                    <div class="col-md-12">
                        <div class="form-group">
                            <iframe id="iframe_channel" title="description" frameborder="0" src="" style="width: 100%; height: 1500px;margin-top:-70px;"></iframe>
                        </div>
                    </div>
                </div>
            </section>
    ...
    <div class="modal center-modal fade" id="modal-center-history" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content" style="width: 850px; margin-left: -200px;">
                ...
                <div class="modal-body" style='width: 100%; height: 600px; overflow: scroll;'>
