...
var Widgetschart = function () {
    ...
    return {
        init: function () {
            ...
            _lineChartWidget('#line_chart_color', 30, '#fff', 'rgba(255,255,255,0.5)', '#fff', '#29B6F6');
            _lineChartWidgetRequest('#line_chart_request1_color', 30, '#fff', 'rgba(255,255,255,0.5)', '#fff', '#29B6F6');
            _lineChartWidgetInquiry('#line_chart_inquiry_color', 30, '#fff', 'rgba(255,255,255,0.5)', '#fff', '#29B6F6');
            _lineChartWidgetRequest('#line_chart_request_color', 30, '#fff', 'rgba(255,255,255,0.5)', '#fff', '#29B6F6');
        }
    }
}();
